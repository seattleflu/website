...
const FlowFour = props => {
  ...
  return (
    <div>
      ...
      {question >= 0 ? (
        <Select
          text='How Long has this person had symptoms?'
          description=''
          label='symptoms'
          type='select'
          id='symptoms'
      ...
      {question >= 1 && question < 7 ? (
        <div>
          <p>Which of the following symptoms does this person currently have?</p>
          <input
            type='checkbox'
            name='test1'
      ...
      {question >= 7 ? (
        <div>
          <p>Which of the following symptoms does this person currently have? option2 </p>
          <input
            type='checkbox'
            name='test1'
            value='Feeling Feverish'
